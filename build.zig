...
pub fn build(b: *std.Build) void {
    ...
    const frontend_install = b.addSystemCommand(&.{ "pnpm", "install", "--filter", "frontend" });
    ...
    const frontend_build = b.addSystemCommand(&.{ "pnpm", "--filter", "frontend", "run", "build" });
